...
#ifndef METAVISION_HAL_IMX636_TZ_DEVICE_H
#define METAVISION_HAL_IMX636_TZ_DEVICE_H
...
public:
    TzImx636(std::shared_ptr<BoardCommand> cmd, uint32_t dev_id, std::shared_ptr<TzDevice> parent);
    virtual ~TzImx636();
...
#endif // METAVISION_HAL_IMX636_TZ_DEVICE_H
